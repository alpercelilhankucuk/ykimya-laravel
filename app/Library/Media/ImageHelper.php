        ...
        try {
            ...
            switch ($type) {
                case 'picture' :
                    ...
                    break;
                case 'lazy' :
                    $tagSrc    = 'src="storage/'. (Cache::get('generalSettings')->loading_gif) .'"';
                    $tagLazy   = 'loading="lazy"';
                    $imgTag    = '<img '.$tagLazy.' '.$tagSrc.' '.$tagWidth.' '.$tagHeight.' '.$tagDataSrc.' '.$attribute.' '.$tagSrcSet.'>';
                    break;
                case 'slider' :
